<%@ Page Title="Edit Report" Language="C#" MasterPageFile="~/Lab/Lab.Master" AutoEventWireup="true" CodeBehind="edit-report.aspx.cs" Inherits="LMS.Lab.edit_report" %>
        ...
        <div class="container-fluid">
            <div class="main-content pt-3 min-vh-100">
                ...
                <div class="bg-white rounded-new mt-4">
                    <h3 class="head-title">Edit Test Result
                    </h3>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="tablesearch">
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="RepeaterTestResult" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td><%# Container.ItemIndex + 1 %></td>
                                                    <td>
                                                        <asp:HiddenField ID="HiddenFieldReportId" Value='<%#Eval("ReportID") %>' runat="server" />
                                                        <%#Eval("TestName") %>
                                                    <td>
                                                        <asp:TextBox ID="TextBoxResult" CssClass="form-control" runat="server" Text='<%#Eval("Result") %>'></asp:TextBox></td>
                                                    <%--<td>
                            ...
                            <asp:LinkButton ID="LinkButtonUpdateResult" runat="server" CssClass="btn btn-success" OnClick="LinkButtonUpdateResult_Click" OnClientClick="loading()">Save</asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
