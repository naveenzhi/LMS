<%@ Page Title="Order" Language="C#" MasterPageFile="~/Lab/Lab.Master" AutoEventWireup="true" CodeBehind="order.aspx.cs" Inherits="LMS.Lab.order" %>
                                                    ...
                                                    <td>
                                                        <div class="dropdown dropleft">
                                                            ...
                                                            <div class="dropdown-menu animated fadeIn">
                                                                <a href="#" data-toggle="modal" data-target="#edit<%#Eval("OrderID") %>" class="dropdown-item text-primary"><i class="fas fa-edit mr-2"></i>Edit</a>
                                                                <a class="dropdown-item" href="invoice.aspx?oid=<%#Eval("OrderID") %>"><i class="fas fa-file-invoice mr-2"></i>View Reciept</a>

                                                            </div>
                                                        </div>

                                                        <div class="modal fade" id="edit<%#Eval("OrderID") %>" tabindex="-1" role="dialog" aria-labelledby="editLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content border-0">
                                                                    <div class="modal-header bg-blue">
                                                                        <h5 class="modal-title text-white" id="editLabel"></h5>
